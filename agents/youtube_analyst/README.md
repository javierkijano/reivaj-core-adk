...
**Create the project from this sample** (replace `my-youtube_analyst` with your project name):

```bash
agents-cli create my-youtube_analyst -a adk@youtube_analyst
```
...
1.  **Clone the repository:**
    ...
    cd adk-samples/python/agents/youtube_analyst
    ```
