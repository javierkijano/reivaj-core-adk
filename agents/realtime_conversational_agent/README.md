...
## Features
<img src="realtime_conversational_agent.png" alt="realtime conversational agent" width="800"/>
...
**Create the project from this sample** (replace `my-realtime-agent` with your project name):

```bash
agents-cli create my-realtime-agent -a adk@realtime_conversational_agent
```
