...
parallel_checkers = ParallelAgent(
    name="decomposition_evaluator",
    description="Runs independent decomposition quality checks in parallel.",
    sub_agents=[
        coverage_checker,
        granularity_checker,
        dependency_checker,
...
final_parallel_checkers = ParallelAgent(
    name="final_decomposition_evaluator",
    description="Re-runs quality checks against the final repaired graph.",
    sub_agents=[
...
root_agent = SequentialAgent(
    ...
    description="Transforms a complex goal into a validated executable TaskGraph.",
    sub_agents=[
        goal_interpreter,
        state_abstractor,
